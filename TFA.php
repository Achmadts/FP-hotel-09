...
$email = isset($_SESSION["TFA"]["email"]) ? $_SESSION["TFA"]["email"] : null;
    ...
    if ($mode === 'enter_code') {
        ...
        if ($result == "Kode OTP benar") {
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                // Penanganan jika tidak dapat mendapatkan informasi pengguna
...
function kode_benar($code, $email)
{
    ...
    return "Sesi verifikasi email tidak ditemukan";
}
?>
    ...
    ?>
            <form action="" id="timerForm" method="POST">
                <div class="container" style="width: 100%;">
                    ...
                    <h6 style="font-size: 90%; margin-bottom: 15px;">Masukkan kode OTP yang dikirim ke: <br> <?php echo isset($_SESSION['TFA']['email']) ? htmlspecialchars($_SESSION['TFA']['email']) : ''; ?></h6>
                    <div class="error-msg">
                        <?php
                        if (!empty($error)) {
