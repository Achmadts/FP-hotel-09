<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="list.php">Data Pengunjung</a></li>
                        </ul>
                    </li>
            </ul>
            ...
            <a href="https://www.instagram.com/neskar.story/"><img src="WhatsApp_Image_2023-09-05_at_15.02.31-removebg-preview.png.png" width="41" height="40" class="ms-5 me-0 mb-3" style="margin-top: -5px;"></a>
        </div>
    </div>
</nav>