...
class GoogleCloudDialogflowCxV3ImportIntentsResponseConflictingResources extends \Google\Collection
{
...
class_alias(GoogleCloudDialogflowCxV3ImportIntentsResponseConflictingResources::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ImportIntentsResponseConflictingResources');
