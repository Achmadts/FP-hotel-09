 ...
 * <a href="https://cloud.google.com/data-catalog" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
class Datalineage extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->projects_locations_processes = new Datalineage\Resource\ProjectsLocationsProcesses(
        $this,
        $this->serviceName,
        'processes',
        [
    ...
    $this->projects_locations_processes_runs = new Datalineage\Resource\ProjectsLocationsProcessesRuns(
        $this,
        $this->serviceName,
        'runs',
        [
    ...
    $this->projects_locations_processes_runs_lineageEvents = new Datalineage\Resource\ProjectsLocationsProcessesRunsLineageEvents(
        $this,
        $this->serviceName,
        'lineageEvents',
        [
...
class_alias(Datalineage::class, 'Google_Service_Datalineage');
