 ...
 *   $locations = $rapidmigrationassessmentService->projects_locations;
 *  </code>
 */
...
class_alias(ProjectsLocations::class, 'Google_Service_RapidMigrationAssessment_Resource_ProjectsLocations');
