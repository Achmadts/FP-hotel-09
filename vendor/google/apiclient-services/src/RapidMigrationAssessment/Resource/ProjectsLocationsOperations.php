 ...
 *   $operations = $rapidmigrationassessmentService->projects_locations_operations;
 *  </code>
 */
class ProjectsLocationsOperations extends \Google\Service\Resource
{
   ...
   * @return RapidmigrationassessmentEmpty
   */
  public function cancel($name, CancelOperationRequest $postBody, $optParams = [])
  {
    $params = ['name' => $name, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('cancel', [$params], RapidmigrationassessmentEmpty::class);
  }
  /**
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], RapidmigrationassessmentEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_RapidMigrationAssessment_Resource_ProjectsLocationsOperations');
