...
class RegionNetworkEndpointGroupsDetachEndpointsRequest extends \Google\Collection
{
...
class_alias(RegionNetworkEndpointGroupsDetachEndpointsRequest::class, 'Google_Service_Compute_RegionNetworkEndpointGroupsDetachEndpointsRequest');
