 ...
 *  </code>
 */
class NetworkEdgeSecurityServices extends \Google\Service\Resource
{
  /**
  ...
  public function aggregatedList($project, $optParams = [])
  {
    ...
    return $this->call('aggregatedList', [$params], NetworkEdgeSecurityServiceAggregatedList::class);
  }
  /**
   ...
   * @param string $networkEdgeSecurityService Name of the network edge security
   * service to delete.
   * @param array $optParams Optional parameters.
   *
  ...
  {
    $params = ['project' => $project, 'region' => $region, 'networkEdgeSecurityService' => $networkEdgeSecurityService];
    $params = array_merge($params, $optParams);
  ...
  public function get($project, $region, $networkEdgeSecurityService, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'networkEdgeSecurityService' => $networkEdgeSecurityService];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], NetworkEdgeSecurityService::class);
  }
  /**
   * Creates a new service in the specified project using the data included in the
   * request. (networkEdgeSecurityServices.insert)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param NetworkEdgeSecurityService $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string requestId An optional request ID to identify requests.
   * Specify a unique request ID so that if you must retry your request, the
  ...
  {
    $params = ['project' => $project, 'region' => $region, 'networkEdgeSecurityService' => $networkEdgeSecurityService, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
...
class_alias(NetworkEdgeSecurityServices::class, 'Google_Service_Compute_Resource_NetworkEdgeSecurityServices');
