 ...
 *  </code>
 */
class InterconnectLocations extends \Google\Service\Resource
{
  /**
  ...
  {
    $params = ['project' => $project, 'interconnectLocation' => $interconnectLocation];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], InterconnectLocation::class);
  }
  /**
  ...
  public function listInterconnectLocations($project, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], InterconnectLocationList::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(InterconnectLocations::class, 'Google_Service_Compute_Resource_InterconnectLocations');
