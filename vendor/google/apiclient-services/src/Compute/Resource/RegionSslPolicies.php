 ...
 *  </code>
 */
class RegionSslPolicies extends \Google\Service\Resource
{
  /**
  ...
  {
    $params = ['project' => $project, 'region' => $region, 'sslPolicy' => $sslPolicy];
   ...
   * included in the request. (regionSslPolicies.insert)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   ...
   * project and region. (regionSslPolicies.listRegionSslPolicies)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param array $optParams Optional parameters.
   ...
   * profile. (regionSslPolicies.listAvailableFeatures)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param array $optParams Optional parameters.
  ...
  {
    $params = ['project' => $project, 'region' => $region, 'sslPolicy' => $sslPolicy, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
...
class_alias(RegionSslPolicies::class, 'Google_Service_Compute_Resource_RegionSslPolicies');
