 ...
 *  </code>
 */
class InterconnectRemoteLocations extends \Google\Service\Resource
{
  /**
   ...
   * @param string $interconnectRemoteLocation Name of the interconnect remote
   * location to return.
  ...
  {
    $params = ['project' => $project, 'interconnectRemoteLocation' => $interconnectRemoteLocation];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], InterconnectRemoteLocation::class);
  }
  /**
  ...
  public function listInterconnectRemoteLocations($project, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], InterconnectRemoteLocationList::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(InterconnectRemoteLocations::class, 'Google_Service_Compute_Resource_InterconnectRemoteLocations');
