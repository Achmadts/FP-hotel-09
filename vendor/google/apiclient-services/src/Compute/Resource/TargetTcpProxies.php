 ...
 *  </code>
 */
class TargetTcpProxies extends \Google\Service\Resource
{
  /**
   * Retrieves the list of all TargetTcpProxy resources, regional and global,
   * available to the specified project. (targetTcpProxies.aggregatedList)
   *
  ...
  public function aggregatedList($project, $optParams = [])
  {
    ...
    return $this->call('aggregatedList', [$params], TargetTcpProxyAggregatedList::class);
  }
  /**
...
class_alias(TargetTcpProxies::class, 'Google_Service_Compute_Resource_TargetTcpProxies');
