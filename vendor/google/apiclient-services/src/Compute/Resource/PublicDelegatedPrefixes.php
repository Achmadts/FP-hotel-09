...
class PublicDelegatedPrefixes extends \Google\Service\Resource
{
   ...
   * @param string $region The name of the region where the public delegated
   * prefix is located. It should comply with RFC1035.
   * @param string $publicDelegatedPrefix The name of the public delegated prefix.
