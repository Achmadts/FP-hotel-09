 ...
 *  </code>
 */
class RegionTargetTcpProxies extends \Google\Service\Resource
{
  /**
  ...
  {
    $params = ['project' => $project, 'region' => $region, 'targetTcpProxy' => $targetTcpProxy];
   ...
   * the data included in the request. (regionTargetTcpProxies.insert)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
...
class_alias(RegionTargetTcpProxies::class, 'Google_Service_Compute_Resource_RegionTargetTcpProxies');
