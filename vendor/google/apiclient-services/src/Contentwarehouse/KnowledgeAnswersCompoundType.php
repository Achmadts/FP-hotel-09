...
class KnowledgeAnswersCompoundType extends \Google\Model
{
...
class_alias(KnowledgeAnswersCompoundType::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersCompoundType');
