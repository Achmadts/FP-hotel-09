...
class AssistantApiDataValidateCapabilities extends \Google\Model
{
  /**
   * @var bool
   */
...
class_alias(AssistantApiDataValidateCapabilities::class, 'Google_Service_Contentwarehouse_AssistantApiDataValidateCapabilities');
