...
class QualityOrbitOrbitImageIntents extends \Google\Collection
{
  ...
  /**
   * @param QualityOrbitOrbitImageIntent[]
   */
  ...
  /**
   * @return QualityOrbitOrbitImageIntent[]
   */
...
class_alias(QualityOrbitOrbitImageIntents::class, 'Google_Service_Contentwarehouse_QualityOrbitOrbitImageIntents');
