...
class KnowledgeAnswersTimeZoneType extends \Google\Model
{
...
class_alias(KnowledgeAnswersTimeZoneType::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersTimeZoneType');
