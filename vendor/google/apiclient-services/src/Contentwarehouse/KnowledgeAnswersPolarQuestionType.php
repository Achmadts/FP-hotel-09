...
class KnowledgeAnswersPolarQuestionType extends \Google\Model
{
...
class_alias(KnowledgeAnswersPolarQuestionType::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersPolarQuestionType');
