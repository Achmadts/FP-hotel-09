...
class KnowledgeAnswersStateOfAffairsType extends \Google\Model
{
...
class_alias(KnowledgeAnswersStateOfAffairsType::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersStateOfAffairsType');
