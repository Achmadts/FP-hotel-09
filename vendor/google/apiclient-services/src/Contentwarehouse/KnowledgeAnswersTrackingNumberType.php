...
class KnowledgeAnswersTrackingNumberType extends \Google\Model
{
...
class_alias(KnowledgeAnswersTrackingNumberType::class, 'Google_Service_Contentwarehouse_KnowledgeAnswersTrackingNumberType');
