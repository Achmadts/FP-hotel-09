...
class_alias(GoogleCloudDiscoveryengineV1alphaEngineChatEngineMetadata::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaEngineChatEngineMetadata');
