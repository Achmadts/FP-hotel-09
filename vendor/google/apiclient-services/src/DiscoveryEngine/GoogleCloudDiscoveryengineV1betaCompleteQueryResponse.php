...
class_alias(GoogleCloudDiscoveryengineV1betaCompleteQueryResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaCompleteQueryResponse');
