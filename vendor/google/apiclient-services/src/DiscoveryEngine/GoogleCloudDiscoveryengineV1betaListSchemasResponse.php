...
class_alias(GoogleCloudDiscoveryengineV1betaListSchemasResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaListSchemasResponse');
