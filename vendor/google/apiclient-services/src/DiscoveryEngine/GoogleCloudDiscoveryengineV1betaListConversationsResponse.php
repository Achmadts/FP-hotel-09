...
class_alias(GoogleCloudDiscoveryengineV1betaListConversationsResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaListConversationsResponse');
