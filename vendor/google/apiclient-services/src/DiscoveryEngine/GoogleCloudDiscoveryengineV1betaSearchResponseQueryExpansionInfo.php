...
class_alias(GoogleCloudDiscoveryengineV1betaSearchResponseQueryExpansionInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaSearchResponseQueryExpansionInfo');
