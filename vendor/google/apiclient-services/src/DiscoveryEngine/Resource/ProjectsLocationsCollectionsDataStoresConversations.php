 ...
 *  </code>
 */
class ProjectsLocationsCollectionsDataStoresConversations extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsCollectionsDataStoresConversations::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsDataStoresConversations');
