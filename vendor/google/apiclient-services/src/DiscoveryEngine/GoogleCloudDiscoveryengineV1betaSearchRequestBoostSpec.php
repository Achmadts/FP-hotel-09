...
class_alias(GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaSearchRequestBoostSpec');
